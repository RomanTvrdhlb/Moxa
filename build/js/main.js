...
const swiper = new (_vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default())('.header-slider', {
  speed: 4000,
  spaceBetween: 94,
  slidesPerView: 'auto',
  loop: true,
...
const swiper2 = new (_vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default())('.logo-slider', {
  grabCursor: true,
  speed: 6000,
  spaceBetween: 30,
  centeredSlides: true,
